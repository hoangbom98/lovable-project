...
// Phase 5: Responsive grid polish & mobile layout improvements
const CategoriesSection = () => (
  <section className="py-10 md:py-12">
    <div className="flex flex-row items-center w-full px-1 md:px-0 mb-7 md:mb-8">
      <h2 className="text-2xl md:text-3xl font-bold tracking-tight">
        Categories
      </h2>
      <Link
        to="/categories"
        className="text-primary hover:text-primary/80 transition-colors font-medium ml-auto mr-2 md:mr-0"
      >
        View all
      </Link>
    </div>

    <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-4 sm:gap-x-6 sm:gap-y-7 md:gap-7 md:px-0 px-1">
